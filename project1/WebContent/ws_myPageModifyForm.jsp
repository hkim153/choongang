				...
				<div id="content">
					<div class="join_content">
						<div class="row_group">
							...
							<span class="ps_box int_id"> <input type="text" value="${name }"
								name="name" required="required" class="int">
							</span>
							<h3 class="join_title">
								<label for="id"> E-Mail </label>
							</h3>
							<span class="ps_box int_id"> <input type="text"  value="${email }"
								name="email" required="required" class="int">
							</span>
							<h3 class="join_title">
								<label for="id">주소</label>
							</h3>
							<span class="ps_box int_id"> <input type="text" value="${address }"
							...
							<input type="submit" value="확인" class="btnColor">	 <input type="reset" value="취소" onclick="location.href='jw_myPage.do'" class="btnColor">
						</div>
					</div>
				</div>
			</div>
